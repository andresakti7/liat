...
#tr="$(cat ~/log-install.txt | grep -w "Trojan WS " | cut -d: -f2|sed 's/ //g')"
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/vless/userexp")
if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
clear
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "   ⇱ Restored Vless Account ⇲       "  | lolcat
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
grep -E "^### " "/etc/vless/userexp" | cut -d ' ' -f 2-4 | nl -s ') '  | lolcat
echo ""
echo ""
echo ""
echo ""
...
user=$(grep -E "^^### " "/etc/vless/userexp" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p)
uuid=$(cat /etc/vless/userexp | grep "### ${user}" | cut -d ' ' -f 4 )
...
echo "### ${user} ${exp} ${tnggl} ${expe} ${uuid} ${Quota} ${iplim}" >>/etc/vless/.vless1.db
clear
systemctl restart xray > /dev/null 2>&1
sed -i "/\b${user}\b/d" /etc/vless/userexp
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " Restored Vless Account Was Successfully Renewed"  | lolcat
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
