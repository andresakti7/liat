...
#tr="$(cat ~/log-install.txt | grep -w "Trojan WS " | cut -d: -f2|sed 's/ //g')"
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/ssh/userexp")
if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
clear
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "   ⇱ Restored SSH Account ⇲       "  | lolcat
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
grep -E "^### " "/etc/ssh/userexp" | cut -d ' ' -f 2-4 | nl -s ') '  | lolcat
echo ""
echo ""
echo ""
echo ""
...
read -p " Limit IP : " limiip
read -p " Expired (Days): " masaaktif
Login=$(grep -E "^^### " "/etc/ssh/userexp" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p)
Pass=$(cat /etc/ssh/userexp | grep "### ${user}" | cut -d ' ' -f 4 )
...
echo "### ${Login} ${Pass} ${expi}" >>/etc/ssh/.ssh.db
echo "### ${Login} ${Pass} ${expi} ${limiip}" >>/etc/ssh/.ssh1.db
echo "${limiip}" > /etc/ssh/limit-ip/$Login 
sed -i "/\b${user}\b/d" /etc/ssh/userexp
clear
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " Restored SSH Account Was Successfully Renewed"  | lolcat
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo " Client Name : $Login"  | lolcat
